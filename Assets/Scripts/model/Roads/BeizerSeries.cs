...
//     [JsonConstructor]
//     public Curve(List<List<float3>> serializedCurves)
//     {
//         RestoreFromSerialization(serializedCurves);
//     }

//     public Curve(List<BezierCurve> c)
//     {
//         curves = c;
//         Length = GetLength();
//     }

//     public Curve(BezierCurve c)
//     {
//         curves = new() { c };
//         Length = GetLength();
//     }

//     public Curve(Curve bs, float startInterpolation, float endInterpolation)
//     {
...
//         bs.Split(endInterpolation, out Curve left, out _);
//         left.Split(startDistance / left.Length, out _, out Curve right);
//         curves = right.curves;
//         Length = right.Length;
//     }
...
//     public void Split(float interpolation, out Curve left, out Curve right)
//     {
