...
public static class Divide
{
    public static SubRoads HandleDivideCommand(Road road, float3 clickPos)
    {
        ...
        road.Curve.GetNearestDistance(new(clickPos, Vector3.down), out float distanceOnCurve);
    ...
    public static SubRoads DivideRoad(Road road, float distanceOnCurve)
    {
        ...
        Build.ConnectRoadStartToIntersection(leftRoad.EndIntersection, 0, rightRoad);
